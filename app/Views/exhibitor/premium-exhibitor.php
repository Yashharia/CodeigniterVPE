<div class="feature-presentation exhibitors-section">
    <?php
    ...
    $the_query = new WP_Query(array(
        ...
        'posts_per_page' => 10,
        'post_status' => 'publish',
        'category_name' => 'premium-exhibitors',
        'order' => 'DESC',
        'paged' => $paged
    ));
    ...
    <?php if ($the_query->have_posts()) : ?>
        ...
        <?php while ($the_query->have_posts()) : $the_query->the_post(); ?>
            ...
            <div class="<?php the_field('show_or_hide_special_offer'); ?> presentation-section <?php the_field('select_main_category'); ?> <?php the_field('show_profile__cover_image'); ?>" style="margin-bottom:0px !important; margin-top:80px; padding-top:0px !important; padding-bottom:20px !important;">
                ...
                <div class="wpb_column vc_column_container vc_col-sm-12 vc_col-lg-12 vc_col-md-12 vc_col-xs-12 text-center profile-cover">
                    <a href="/linkresponse?element=bannerimage&bannerName=<?php if ($the_query) {
                                                                                echo '' . get_the_id($post->ID) . '';
                                                                            } ?>&url=<?php the_field('website_link_for_company_2'); ?>" target="_blank"><img src="<?php the_field('profile_cover_image'); ?>" class="img-responsive" /></a>
                </div>
                ...
                <div class="wpb_column vc_column_container vc_col-sm-12 vc_col-lg-6 vc_col-md-6 vc_col-xs-12 content-section">
                    <div class="vc_column-inner">
                        <h4 class="main-heading text-center" style="margin-top:15px;">
                            <a href="/linkresponse?element=logo&bannerName=<?php if ($the_query) {
                                                                                echo '' . get_the_id($post->ID) . '';
                                                                            } ?>&url=<?php the_field('website_link_for_company_2'); ?>" target="_blank"><img src="<?php the_field('company_logo'); ?>" class="img-thumbnail img-responsive" /></a>
                        </h4>
                ...
                <div class="wpb_column vc_column_container vc_col-sm-12 vc_col-lg-12 vc_col-md-12 vc_col-xs-12 text-center usefull-links margin-top-20">
                    ...
                    if (have_rows('company_website_links')) :
                        ...
                        while (have_rows('company_website_links')) : the_row();
                            ...
                            echo '<a class="mkdf-btn mkdf-btn-small mkdf-btn-solid" href="/linkresponse?element=' . $button_name . '&bannerName=' . get_the_id($post->ID) . '&url=' . $button_link . '" target="_blank" >' . $button_name . '</a>';
                        endwhile;
                    endif;
                    ?>
                </div>
