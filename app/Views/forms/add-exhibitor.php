...
<form method="post" action="/vpe/public/home/newpresentation">
    ...
    <div>
        ...
        <input type="text" name="Website Link for company">
    </div>
    ...
    <div>
        ...
        <input type="file" name="home_company_logo">
    </div>

    <div>
        Home Platinum Company Logo
        Note: This is your logo that will appear on the home page. Image size will be automatically resized to 70px by height.
        <input type="file" name="home_platinum_company_logo">
    </div>
    ...
    <div>
        ...
        <textarea name="youtube_embed_code" id="" cols="30" rows="10"></textarea>
    </div>
    ...
    <div id="myRepeatingFields">
        <div class="entry input-group col-xs-3">
            ...
            Marketing Image
            <input class="form-control" name="speaker_full_names[]" type="text" placeholder="Placeholder" />
            Video Embed Link
            <input class="form-control" name="speaker_job_titles[]" type="text" placeholder="Placeholder" />
    ...
    <div>
        Profile Cover Image
        <input type="file" name="profile_cover_image">
    </div><br><br>
    ...
    <div id="myRepeatingFields">
        <div class="entry input-group col-xs-3">
            <div>
                ...
                <input class="form-control" name="company_website_link[]" type="text" />
            </div>
            <span class="input-group-btn">
                <button type="button" class="btn btn-success btn-lg btn-add">
                    Add Link
    ...
    <div>
        Conference Link
        <input type="text" name="conference_link">
    </div>
    ...
    <div>
        ...
        <input type="text" name="Special Offer Text Only">
    </div>

    <div>
        Click Here Text Only
        <input type="text" name="Click Here Text Only">
    </div>

    <div>
        Special Offer Text: Terms and condition for Special Offer.
        <textarea name="Special Offer Text: Terms and condition for Special Offer." id="" cols="30" rows="10"></textarea>
    </div>

    <div>
        Special offer validity like - "Valid Till June 30th"
        <input type="text" name="Special offer validity">

    </div>

    <div>
        Link for Special offer Details page
        <input type="text" name="Link for Special offer Details page">
    </div>
